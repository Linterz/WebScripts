...
const auth = () => {
  ...
  const observer = new MutationObserver(() => {
    let recieveSmsCode = document.querySelector(
  ...
  setTimeout(() => {
    ...
    switch (url) {
      case "https://s2.lite.msu.edu/adm/roles?source=login":
        let selectButton = document.getElementsByName(
          "stmsu7Z2535691a0b16369msul1001"
        )[0];
        selectButton.click();
        break;
      case "https://loncapa.msu.edu/adm/login":
        let loginButton = document.getElementById("LC_sso_login_link");
        let hrefLink = loginButton?.getAttribute("href");
      ...
      case "https://student.msu.edu/splash.html":
        ...
        let hreflink2 = loginbutton1?.getAttribute("href");
